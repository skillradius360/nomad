...
import { isAdminOrSeller, isBuyer } from "../middleware/admin.middleware.js";
...
bannerRouter.route("/buyer/:shopId/fetchbanners").get(isBuyer,buyerReadRateLimit,fetchPublishedBannersByShop);
